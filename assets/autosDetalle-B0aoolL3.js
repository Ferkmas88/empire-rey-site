import{l as $,e as t}from"./sanitize-nXRFN7Nc.js";import{c as E,_ as I,a as L}from"./forms-DJ9HXPvl.js";/* empty css              */const B=Object.assign({"../../Logo/2026-01-14.webp":L,"../../Logo/2026-01-31.webp":I}),S=a=>Object.values(a).sort()[0],u=S(B),v=document.getElementById("logoImage");u&&v&&(v.src=u);const d=(await $()).filter(a=>a.status!=="hidden"),T=new URLSearchParams(window.location.search),A=T.get("car")||"",C=d.find(a=>a.status!=="sold")||d[0]||null,e=d.find(a=>a.slug===A)||C,s=document.getElementById("detailBreadcrumb"),n=document.getElementById("carDetail"),r=document.querySelector("#cita form"),y=document.getElementById("cita"),h=document.getElementById("detail-vehicle"),f=document.getElementById("detail-car-id");if(!e)document.title="Inventario no disponible | Empire Rey Auto Sales & Mechanic",s&&(s.textContent="Sin inventario"),n&&(n.innerHTML=`
    ...
    `),y&&(y.hidden=!0);else{const a=e.gallery?.length?e.gallery:[e.image||"/favicon.png"],l=e.status==="sold";document.title=`${e.title} | Empire Rey Auto Sales & Mechanic`,s&&(s.textContent=e.title),h&&(h.value=e.title),f&&(f.value=e.id||""),n&&(n.innerHTML=`
